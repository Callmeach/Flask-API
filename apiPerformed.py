...
@app.route('/categories/<int:id_arg>/livres')
...
def not_found(error):
    return jsonify(
        {
            "Success": False,
            "Erreur": "Cette categorie contient des livres! Afin de supprimer la categorie, veuillez d'abord "
                      "supprimer les livres de cette categorie. "
        }
    )
...
def not_found(error):
    return jsonify(
        {
            "Success": False,
            "Message": "La categorie specifiée n'existe pas."
        }
    )
